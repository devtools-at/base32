...
Base32 - Free online developer tool

## Online Tool

Use this tool online at **[DevTools.at](https://devtools.at/tools/base32)** - Free, fast, and no registration required!
...
```bash
npm install @devtools-at/base32
```

### Usage

```javascript
import { process, encode, decode } from '@devtools-at/base32';
...
**[https://devtools.at/tools/base32](https://devtools.at/tools/base32)**
...
- [npm Package](https://www.npmjs.com/package/@devtools-at/base32)
