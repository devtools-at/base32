...
<p align="center">
  <a href="https://devtools.at/tools/base32"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Encode and decode Base32 strings</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/base32">Try Online</a> •
...
**[Try Base32 Encoder/Decoder online at DevTools.at →](https://devtools.at/tools/base32)**
...
Encode and decode Base32 strings. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/base32';
